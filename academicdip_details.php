  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Kindly fill all your details properly. Diploma and SSC details once filled cannot be updated.
      </div>
...
<div class="register-box" style='width: 825px;'>
  ...
  <div class="register-box-body" >
      ...
      <form action="academicdipdb.php" method="post">
   <div class="box-header with-border">
      ...
      <div class="box-header with-border">
              <h1 class="box-title">DIPLOMA</h1>
              	...
              	<div class="col-md-6">
				 <div class="form-group">
                  <label for="inputEmail3" class="col-sm-4 control-label">First Year</label>
                     <div class="col-sm-8">
                    <input type="text" class="form-control" placeholder="marks obtained" name="year1marks" required>
                     </div>
                 </div>
                </div>
                <div class="col-md-6">
                    ...
                    <label for="inputPassword3" class="col-sm-3 control-label"></label>
                        <div class="col-sm-9">
                        <input type="text" class="form-control"  placeholder="Out off" name="year1outoff" required>
                        </div>
                    </div>
                </div>
 <div class="col-md-6">
				 <div class="form-group">
                  <label for="inputEmail3" class="col-sm-4 control-label">Second Year</label>
                     <div class="col-sm-8">
                    <input type="text" class="form-control" placeholder="marks obtained" name="year2marks" required>
                     </div>
                 </div>
                </div>
                <div class="col-md-6">
                    ...
                    <label for="inputPassword3" class="col-sm-3 control-label"></label>
                        <div class="col-sm-9">
                        <input type="text" class="form-control"  placeholder="Out off" name="year2outoff" required>
                        </div>
                    </div>
                </div>
 <div class="col-md-6">
				 <div class="form-group">
                  <label for="inputEmail3" class="col-sm-4 control-label">Third Year</label>
                     <div class="col-sm-8">
                    <input type="text" class="form-control" placeholder="marks obtained" name="year3marks" required>
                     </div>
                 </div>
                </div>
                <div class="col-md-6">
                    ...
                    <label for="inputPassword3" class="col-sm-3 control-label"></label>
                        <div class="col-sm-9">
                        <input type="text" class="form-control"  placeholder="Out off" name="year3outoff" required>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                   <br> <label for="inputPassword3" class="col-sm-4 control-label">Passing Year</label>
                        <div class="col-sm-8">
...
<div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                   <br> <label for="inputPassword3" class="col-sm-4 control-label">Starting Year</label>
                        <div class="col-sm-8">
                   ...
                   <div class="col-md-6">
                    <div class="form-group">
                   <br> <label for="inputPassword3" class="col-sm-3 control-label">Passing Year</label>
                        <div class="col-sm-9">
                        <input type="text" class="form-control" name="py3" >
                        </div>
                    </div>
                </div>
          </div>
       ...
       <div class="col-md-6">
				 <div class="form-group">
                  <label for="inputEmail3" class="col-sm-4 control-label">Live KT</label>
                     <div class="col-sm-8">
                    <input type="text" class="form-control" name="livekt" required> <div class="col-sm-5 no-padding tools" ><a href="#" data-toggle="tooltip" title="Subjects you have not cleared.If result pending then also it is live kt. Each subject 1 only.">?</a></div>
                     </div>
                 </div>
                    </div>
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <div class="col-sm-8">
                              <input type="text" class="form-control" name="deadkt" required><div class="col-sm-5 no-padding tools" ><a href="#" data-toggle="tooltip" title="Subjects you have cleared in past after getting kt. Each subject 1 only. ">?</a></div>
                          </div>
                        </div>
                </div>
    </div><div class="box-body">
                  ...
                  <label for="inputEmail3" class="col-sm-4 control-label">No of Attempts</label>
                     <div class="col-sm-8">
                    <input type="text" class="form-control" name="attempts" required> <div class="col-sm-5 no-padding tools" ><a href="#" data-toggle="tooltip" title="Attempts you made to clear a subject. Each subject can have more than one attempts.">?</a></div>
                     </div>
                 </div>
                </div>
